...
public class Boss_run_2 : StateMachineBehaviour
{
    ...
    public override void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        else if (Vector2.Distance(rb.position, player.position) > swordAttackRange && Vector2.Distance(rb.position, player.position) <= spellRange)
        {
            //Debug.Log("Spell");
